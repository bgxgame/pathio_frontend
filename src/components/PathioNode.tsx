...
export default function PathioNode({ data, selected }: { data: any, selected: boolean }) {
  ...
  return (
    <div className={`relative px-3 py-2 bg-white border rounded-xl transition-all duration-300 w-36 shadow-sm select-none ${
      selected 
        ? 'border-pathio-500 shadow-md ring-1 ring-pathio-500/20' 
